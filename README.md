...
* [Instructions](#instructions)
  ...
  * [Step 2 (Flash the Printer’s Microcontroller)](#step-2-(flash-the-printer's-microcontroller))
  ...
  * [Step 5 (Install the Raspberry Pi and Buck Converter)](#step-5-(install-the-raspberry-pi-and-buck-converter))
  * [Step 6: (Configure the Z-Offset & Bed Mesh)](#step-6-(configure-the-z-offset-&-bed-mesh))
  * [Step 7: (Configure Macros & Slicer)](#step-7-(configure-macros-and-slicer))
